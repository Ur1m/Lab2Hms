...
export default observer(function CaktoShtratinForm() {
    ...
    const validationSchema = Yup.object({
        kohahyrjes: Yup.string().required('Selektoni kohen kur eshte caktuar shtrati...').nullable(),
        kohaleshimit: Yup.string().required('Selektoni kohen kur eshte leshuar shtrati...').nullable(),
                    ...
                    <Form className='ui form' onSubmit={handleSubmit} autoComplete='off'>
                        ...
                        <Button
                           disabled={isSubmitting || !dirty || !isValid}
                            loading={loading}
                            floated='right' positive type='submit' content='Cakto' />
