...
import { store, StoreContext, StorePacientat,StoreContextPacientat, StoreDoktorat,StoreContextDoktorat, StoreContextTerminet, StoreTerminet, StoreTherapies, StoreContextTherapies, StoreContextRaport, StoreRaport, StoreLaboratoret, StoreContextLaboratori } from './app/stores/store';
